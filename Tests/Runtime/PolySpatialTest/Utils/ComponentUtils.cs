...
namespace Tests.Runtime.PolySpatialTest.Utils
{
    ...
    internal static class BackingComponentUtils
    {
        ...
        {
            return (GetUnitySceneGraph())?.FindUnitySceneGraphGameObjectForId(simulationInstanceId);
        }
        ...
        {
            return (GetUnitySceneGraph()) == null ? default : GetUnitySceneGraph().UnitySceneGraphGameObjects.Values.ToList();
        }
        ...
        {
            GetUnitySceneGraph()?.DeleteEntity(simulationInstanceId);
        }
    }
    ...
    internal static class PolySpatialComponentUtils
    {
        ...
        internal static DefaultTrackingData GetTrackingData(VolumeCamera qvc)
        {
            return GetPolySpatialVolumeCameraTrackingData(qvc.GetInstanceID());
        }

        internal static DefaultTrackingData GetTrackingData(Camera cam)
        {
            return GetCameraTrackingData(cam.GetInstanceID());
        }
        ...
        internal static DefaultTrackingData GetCameraTrackingData(int iid)
        {
            return CameraTracker.GetTrackingData(iid).defaultData;
        }
