...
namespace Unity.PolySpatial
{
...
#endif
    {
        ...
        {
            [InspectorName("Enabled For visionOS Only")]
        ...
        [Tooltip("Whether or not to minify shader graph node names (improves load performance on visionOS).")]
        [SerializeField]
        bool m_MinifyShaderGraphNodeNames = true;

        [Tooltip("Override the camera background color to use in the editor play mode Game window, to help indiate that the PolySpatial scene is visible.")]
        [SerializeField]
        internal bool m_PreviewUseBackgroundColor = true;

        [Tooltip("A camera background color to use in the editor in play mode Game window, to help indicate that the PolySpatial scene is visible.")]
        [SerializeField]
        internal Color m_PreviewBackgroundColor = new Color(0.192f, 0.301f, 0.474f);
        ...
        internal bool MinifyShaderGraphNodeNames => m_MinifyShaderGraphNodeNames;
#endif
