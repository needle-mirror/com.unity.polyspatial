...
namespace UnityEditor.PolySpatial
{
    ...
    class PolySpatialSettingsEditor : Editor
    {
        ...
        SerializedProperty m_MinifyShaderGraphNodeNamesProperty;
        ...
        SerializedProperty m_PreviewUseBackgroundColorProperty;
        SerializedProperty m_PreviewBackgroundColorProperty;

        SerializedProperty m_EnablePolySpatialRaycasterProperty;
        ...
        void OnEnable()
        {
            ...
            m_MinifyShaderGraphNodeNamesProperty = serializedObject.FindProperty("m_MinifyShaderGraphNodeNames");
            ...
            m_PreviewUseBackgroundColorProperty = serializedObject.FindProperty("m_PreviewUseBackgroundColor");
            m_PreviewBackgroundColorProperty = serializedObject.FindProperty("m_PreviewBackgroundColor");
            m_EnablePolySpatialRaycasterProperty = serializedObject.FindProperty("m_EnablePolySpatialRaycaster");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorGUILayout.PropertyField(m_SelectedValidationTypeProperty, new GUIContent( "Selected Validation Type"));
                if (check.changed)
                {
            ...
            EditorGUILayout.PropertyField(m_MinifyShaderGraphNodeNamesProperty,
                new GUIContent("Minify ShaderGraph Node Names"));
            EditorGUILayout.PropertyField(m_PreviewUseBackgroundColorProperty, new GUIContent("Force Game View Background Color"));
            using (var disabled = new EditorGUI.DisabledScope(!m_PreviewUseBackgroundColorProperty.boolValue))
            {
                EditorGUILayout.PropertyField(m_PreviewBackgroundColorProperty, new GUIContent("Game View Background Color"));
            }
            EditorGUILayout.PropertyField(m_EnablePolySpatialRaycasterProperty, new GUIContent("Auto-Add PolySpatial Raycaster"));
