...
namespace UnityEditor.PolySpatial.Internals
{
    ...
    class VolumeCameraEditor : Editor
    {
        ...
        SerializedProperty m_OnWindowEventProperty;
        ...
        void OnEnable()
        {
            ...
            m_OnWindowEventProperty = serializedObject.FindProperty("OnWindowEvent");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (var changed = new EditorGUI.ChangeCheckScope())
            {
                ...
                {
                    EditorGUILayout.PropertyField(m_OnWindowEventProperty);
                }
